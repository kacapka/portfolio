...
const lang = {
    ...
    pl: {
        ...
        about: {
            ...
            description: <p>Jetsem front-end developerem, miłośnikiem JavaScriptu i technologii webowych. Swoją przygodę z kodowaniem zacząłem ponad rok temu czego owocem bybła moja piersza <a href='' target='_blank' className='about__link'>strona.</a> Wraz z czasem stawiałem sobie wyżej poprzeczkę i realizowałem kolejne <a href='/projects' className='about__link'>projekty.</a> Aktualnie pracuje przy użyciu react oraz redux. Nie jestem fanem jQery oraz bootstrap. W swoich pracach również nie korzystam z szablonów i gotowych layoutów. W kolejnych projektach chciałbym tworzyć unikatowe aplikacje, które będą wymagać odemnie ciągłego rozwoju i rozwiązywania nowych problemów.</p>,
